...
public final class StringToUrlConverter implements Converter<String, URL> {
    ...
    @Override
    public @NotNull URL convert(@NotNull String source, @NotNull Type sourceType, @NotNull Type targetType) {
        try {
            return new URL(source);
        } catch (final MalformedURLException e) {
            throw new ConversionFailedException(sourceType, targetType, "URL");
        }
    }
}
