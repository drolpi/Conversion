...
public final class StringToUriConverter implements Converter<String, URI> {
    ...
    @Override
    public @NotNull URI convert(@NotNull String source, @NotNull Type sourceType, @NotNull Type targetType) {
        try {
            return new URI(source);
        } catch (final URISyntaxException e) {
            throw new ConversionFailedException(sourceType, targetType, "URI");
        }
    }
}
